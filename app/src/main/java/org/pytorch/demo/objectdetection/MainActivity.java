...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        json1=new Json(getApplicationContext());
        mImageView = findViewById(R.id.imageView);
        //mImageView.setImageBitmap(mBitmap);
        //ImageView.setVisibility(View.VISIBLE);
        mResultView = findViewById(R.id.resultView);
        mResultView.setVisibility(View. VISIBLE);
        mResultNum=findViewById(R.id.resultNum);
        ...
        final Button buttonHistory=findViewById(R.id.historyButtton);
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("classes_insects.txt")));
            String line;
                    ...
                    if (resultCode == RESULT_OK && data != null) {
                        ...
                        if (selectedImage != null) {
                            ...
                            if (cursor != null) {
                                ...
                                json1.name=picturePath;
                                json1.time= (new Date(System.currentTimeMillis())).toString();
    ...
    public void run() {
        ...
        runOnUiThread(() -> {
            ...
            num=mResultView.getNum();
            mResultNum.setText(String.format("adult:%d\nlarvae:%d", num[0], num[1]));
           // json1.data=num;
           // json1.save();
